...
const CarrosselSete = (props) => {
    const swiperRef = React.useRef(null)

    return (
      <div className={`relative py-12 ${props.className}`}>
          <Swiper
              {...props.carouselOption}
              ref={swiperRef}
              className="testimonial-carousel-style-07 text-center swiper-default-nav-hidden "
...
export default memo(CarrosselSete);